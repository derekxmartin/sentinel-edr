/*
 * akesoedr-agent/cmd_handler.h
 * Command pipe server for CLI → agent communication.
 *
 * Listens on \\.\pipe\AkesoEDRCommand for CLI connections.
...
#ifndef AKESOEDR_CMD_HANDLER_H
#define AKESOEDR_CMD_HANDLER_H
...
public:
    ...
    void Start(EventProcessor* processor,
               ...
               const AkesoEDRConfig* config = nullptr);
...
private:
    ...
    const AkesoEDRConfig*   m_config    = nullptr;
