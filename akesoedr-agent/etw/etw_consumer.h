/*
 * akesoedr-agent/etw/etw_consumer.h
 ...
 * AKESOEDR_EVENT and pushed into the agent's EventQueue.
 *
 * P7-T1: ETW Consumer Framework + .NET Provider.
 * Book reference: Chapter 8 — Event Tracing for Windows.
 */

#ifndef AKESOEDR_ETW_CONSUMER_H
#define AKESOEDR_ETW_CONSUMER_H
 ...
 * Events are converted to AKESOEDR_EVENT and pushed to g_EventQueue.
 *
