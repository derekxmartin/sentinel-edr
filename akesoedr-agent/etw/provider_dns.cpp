/*
 * akesoedr-agent/etw/provider_dns.cpp
...
bool
ParseDnsEvent(PEVENT_RECORD pEvent, AKESOEDR_EVENT* outEvent)
{
    ...
    etw->Provider  = AkesoEDREtwDnsClient;
    ...
    /* Copy QueryName (bounded by AKESOEDR_MAX_PATH = 520 WCHARs) */
