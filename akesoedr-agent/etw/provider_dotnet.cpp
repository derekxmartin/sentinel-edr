/*
 * akesoedr-agent/etw/provider_dotnet.cpp
...
bool
ParseDotNetEvent(PEVENT_RECORD pEvent, AKESOEDR_EVENT* outEvent)
{
    ...
    etw->Provider  = AkesoEDREtwDotNet;
