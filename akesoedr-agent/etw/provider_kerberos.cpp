/*
 * akesoedr-agent/etw/provider_kerberos.cpp
...
bool
ParseKerberosEvent(PEVENT_RECORD pEvent, AKESOEDR_EVENT* outEvent)
{
    ...
    etw->Provider  = AkesoEDREtwKerberos;
    ...
    /* Copy TargetName (bounded by AKESOEDR_MAX_PATH = 520 WCHARs) */
