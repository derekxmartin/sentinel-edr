/*
 * akesoedr-agent/etw/provider_kernelprocess.h
...
#ifndef AKESOEDR_ETW_PROVIDER_KERNELPROCESS_H
#define AKESOEDR_ETW_PROVIDER_KERNELPROCESS_H
...
/*
 * Parse a Kernel-Process ETW event into a AKESOEDR_EVENT.
 *
 * Handles:
 ...
 */
bool ParseKernelProcessEvent(PEVENT_RECORD pEvent, AKESOEDR_EVENT* outEvent);

#endif /* AKESOEDR_ETW_PROVIDER_KERNELPROCESS_H */
