/*
 * akesoedr-agent/etw/provider_powershell.cpp
...
bool
ParsePowerShellEvent(PEVENT_RECORD pEvent, AKESOEDR_EVENT* outEvent)
{
    ...
    etw->Provider  = AkesoEDREtwPowerShell;
    ...
    if (copyLen >= AKESOEDR_MAX_SCRIPT_BLOCK) {
        copyLen = AKESOEDR_MAX_SCRIPT_BLOCK - 1;
    }
