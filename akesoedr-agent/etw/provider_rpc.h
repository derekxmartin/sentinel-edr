/*
 * akesoedr-agent/etw/provider_rpc.h
...
#ifndef AKESOEDR_ETW_PROVIDER_RPC_H
#define AKESOEDR_ETW_PROVIDER_RPC_H
...
/*
 * Parse an RPC ETW event into a AKESOEDR_EVENT.
 *
 * Handles:
 ...
 */
bool ParseRpcEvent(PEVENT_RECORD pEvent, AKESOEDR_EVENT* outEvent);

#endif /* AKESOEDR_ETW_PROVIDER_RPC_H */
