/*
 * akesoedr-agent/network_table.cpp
 * In-memory connection table implementation.
 *
 * Aggregates AKESOEDR_NETWORK_EVENT telemetry into connection entries
...
void
NetworkTable::OnNetworkEvent(const AKESOEDR_EVENT& evt)
{
