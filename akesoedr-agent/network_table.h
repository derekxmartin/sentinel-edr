/*
 * akesoedr-agent/network_table.h
 ...
 * updated from AKESOEDR_NETWORK_EVENT telemetry. Each entry tracks connection
...
#ifndef AKESOEDR_NETWORK_TABLE_H
#define AKESOEDR_NETWORK_TABLE_H
...
public:
     ...
     * Ignores non-network events (source != AkesoEDRSourceDriverNetwork).
     * Upserts the connection entry keyed by {RemoteAddr, RemotePort, Protocol}.
     */
    void OnNetworkEvent(const AKESOEDR_EVENT& evt);
...
#endif /* AKESOEDR_NETWORK_TABLE_H */
