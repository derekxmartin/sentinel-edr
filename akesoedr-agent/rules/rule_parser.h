/*
 * akesoedr-agent/rules/rule_parser.h
...
#ifndef AKESOEDR_RULE_PARSER_H
#define AKESOEDR_RULE_PARSER_H
...
private:
    ...
    static AKESOEDR_SEVERITY   ParseSeverity(const std::string& sev);
    static AKESOEDR_EVENT_SOURCE ParseSource(const std::string& src);
