...
#ifndef AKESOEDR_RULE_TYPES_H
#define AKESOEDR_RULE_TYPES_H
...
struct DetectionRule {
    std::string                         name;
    std::vector<AKESOEDR_EVENT_SOURCE>  sources;    /* Empty = match all */
