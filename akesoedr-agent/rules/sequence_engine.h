/*
 * akesoedr-agent/rules/sequence_engine.h
...
#ifndef AKESOEDR_SEQUENCE_ENGINE_H
#define AKESOEDR_SEQUENCE_ENGINE_H
...
public:
     ...
     * If a sequence completes, an alert AKESOEDR_EVENT is appended.
     */
...
private:
    ...
    bool StepMatches(const AKESOEDR_EVENT& evt,
...
#endif /* AKESOEDR_SEQUENCE_ENGINE_H */
