/*
 * akesoedr-agent/rules/threshold_engine.h
...
#ifndef AKESOEDR_THRESHOLD_ENGINE_H
#define AKESOEDR_THRESHOLD_ENGINE_H
...
public:
     ...
     * If a threshold is exceeded, an alert AKESOEDR_EVENT is appended.
     */
...
private:
    ...
    bool MatchesFilter(const AKESOEDR_EVENT& evt,
...
#endif /* AKESOEDR_THRESHOLD_ENGINE_H */
