/*
 * akesoedr-agent/scanner/yara_scanner.h
 * YARA scanner module.
 *
...
#ifndef AKESOEDR_YARA_SCANNER_H
#define AKESOEDR_YARA_SCANNER_H
...
public:
     ...
     * rulesDir: path containing *.yar files (e.g., "C:\\AkesoEDR\\yara-rules").
