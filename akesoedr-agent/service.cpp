...
void
RunConsoleMode(const AkesoEDRConfig& cfg)
{
    std::printf("AkesoEDRAgent: Running in console mode (Ctrl+C to stop)\n");
    ...
    std::printf("AkesoEDRAgent: Pipeline started, waiting for events...\n");
    ...
    std::printf("AkesoEDRAgent: Stopped.\n");
}
