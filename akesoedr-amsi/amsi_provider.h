...
#ifndef AKESOEDR_AMSI_PROVIDER_H
#define AKESOEDR_AMSI_PROVIDER_H
...
class AkesoEDRAmsiProvider : public IAntimalwareProvider {
public:
    AkesoEDRAmsiProvider();
    ~AkesoEDRAmsiProvider();
...
class AkesoEDRAmsiClassFactory : public IClassFactory {
public:
    AkesoEDRAmsiClassFactory();
...
#endif /* AKESOEDR_AMSI_PROVIDER_H */
