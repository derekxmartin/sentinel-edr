 ...
 *     as AKESOEDR_MAX_PIPE_NAME (256), repurposed for pipe events
    ...
    PLARGE_INTEGER          DefaultTimeout)
{
    ...
    if (AkesoEDREnterHook()) {
        ...
        evt.Function        = AkesoEDRHookNtCreateNamedPipeFile;
